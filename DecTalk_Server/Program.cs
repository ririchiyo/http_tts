...
namespace DecTalk
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SpeechSynthesizer tts_voices = new SpeechSynthesizer();
            using (System.IO.StreamWriter file = new System.IO.StreamWriter("../../config/text_to_speech/voices.txt",false,Encoding.UTF8)) {
                foreach (InstalledVoice voice in tts_voices.GetInstalledVoices()) {
                    file.WriteLine(voice.VoiceInfo.Name);
                }
            }
